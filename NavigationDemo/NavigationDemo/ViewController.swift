...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.leftBarButtonItem = UIBarButtonItem(title: "返回", style: .plain, target: self, action: #selector(pop))
        
        self.navigationItem.title = "第\(i)个视图控制器"
        self.navigationItem.titleView = UIImageView(image: UIImage(named:"navigationbar_friendsearch_highlighted"))
